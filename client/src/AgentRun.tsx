...
export function AgentRunView({ run, icon }: { run?: AgentRun; icon: (app: AppName) => React.ReactNode }) {
  if (!run) return <div className="section-intro"><h3>No agent run was recorded.</h3></div>;
  ...
  return <div className="activity-list">
    <div className="section-intro">
      <h3>{run.agent} made {changes} changes. {needsRepair} need repair.</h3>
