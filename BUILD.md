...
Validation: 81 regression tests, two browser workflows, 450 simulated-API trials, and 27 real-model development trials on simulated state passed; frozen holdouts scored 10/12 (four cases) and, after one fix, 15/15 (five new cases). The earlier 8/27 model baseline and current limits are retained in VALIDATION.md. Coverage includes
