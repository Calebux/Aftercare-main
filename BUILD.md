...
Validation: 70 regression tests, two browser workflows, 450 simulated-API trials, and 27 real-model development trials on simulated state passed; a frozen four-case holdout scored 10/12. The earlier 8/27 model baseline and current limits are retained in VALIDATION.md. Coverage includes
