...
- [EVALUATION-HOLDOUT-V2.md](EVALUATION-HOLDOUT-V2.md): five more new cases, frozen the same way after out-of-scope reads started getting corrective feedback; 15/15 passed.
